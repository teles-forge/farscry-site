...
## Zero-friction clipboard workflow

The fastest way to use farscry is a shell alias that runs everything in one command.
...
Then:
1. Take a screenshot with Shottr or `Cmd+Shift+4`
2. Type: `ffix`
3. Enter

farscry reads the image from your clipboard, extracts VASP context, and pipes it to Claude.
No file saving. No path typing. No friction.
